/*
Design a cash register drawer function console.log(checkCashRegister() that accepts purchase 
...
The console.log(checkCashRegister() function should always return an object with a status 
